...
dnl
dnl Generated by phcvs2 at Fri Apr  5 13:26:46 2019
dnl on aw-bld-node-34.aw.intel.com.
dnl ---------------------------------------------------------------------------
...
m4_define([mca_opal_common_m4_config_component_list], [cuda, ugni, libfabric, verbs, sm, verbs_usnic])
...
m4_define([mca_opal_allocator_no_config_component_list], [bucket, basic])
...
m4_define([mca_opal_btl_m4_config_component_list], [vader, portals4, ugni, smcuda, scif, usnic, sm, openib, tcp])
...
m4_define([mca_opal_if_m4_config_component_list], [posix_ipv4, linux_ipv6, bsdx_ipv6, bsdx_ipv4, solaris_ipv6])
...
m4_define([mca_opal_pmix_m4_config_component_list], [s2, s1, pmix112, cray, external])
...
m4_define([mca_opal_rcache_m4_config_component_list], [rgpusm, udreg, gpusm])
...
m4_define([mca_opal_timer_m4_config_component_list], [linux, darwin, solaris, altix])
...
m4_define([mca_orte_ess_m4_config_component_list], [tm, lsf, slurm, alps])
m4_define([mca_orte_ess_no_config_component_list], [env, singleton, pmi, tool, hnp])
...
m4_define([mca_orte_iof_no_config_component_list], [mr_hnp, tool, mr_orted, orted, hnp])
...
m4_define([mca_orte_oob_m4_config_component_list], [usock, alps, ud, tcp])
m4_define([mca_orte_oob_no_config_component_list], [])

dnl Components in the orte / plm framework
m4_define([mca_orte_plm_m4_config_component_list], [rsh, isolated, tm, lsf, slurm, alps])
m4_define([mca_orte_plm_no_config_component_list], [])

dnl Components in the orte / ras framework
m4_define([mca_orte_ras_m4_config_component_list], [tm, gridengine, loadleveler, lsf, slurm, alps])
...
m4_define([mca_orte_rmaps_no_config_component_list], [round_robin, resilient, ppr, seq, mindist, rank_file, staged])
...
m4_define([mca_orte_state_no_config_component_list], [app, staged_orted, tool, dvm, orted, hnp, novm, staged_hnp])
...
m4_define([mca_ompi_coll_m4_config_component_list], [hcoll, portals4, cuda, fca])
m4_define([mca_ompi_coll_no_config_component_list], [self, basic, sync, libnbc, sm, tuned, inter])
...
m4_define([mca_ompi_fcoll_no_config_component_list], [static, two_phase, dynamic, dynamic_gen2, individual])
...
m4_define([mca_ompi_io_m4_config_component_list], [romio314, ompio])
m4_define([mca_ompi_io_no_config_component_list], [])

dnl Components in the ompi / mtl framework
m4_define([mca_ompi_mtl_m4_config_component_list], [mxm, portals4, psm, ofi, psm2])
...
m4_define([mca_ompi_osc_m4_config_component_list], [portals4, rdma, pt2pt])
m4_define([mca_ompi_osc_no_config_component_list], [sm])

dnl Components in the ompi / pml framework
m4_define([mca_ompi_pml_m4_config_component_list], [ucx, yalla, ob1, v])
...
m4_define([mca_oshmem_sshmem_m4_config_component_list], [sysv, mmap, verbs])
...
m4_define([ompi_mpiext_list], [cuda, affinity])
