...
dnl
dnl Generated by mpiteam at Tue Jan 31 15:17:31 2017
...
m4_define([mca_opal_common_m4_config_component_list], [sm, verbs, cuda, libfabric, ugni, verbs_usnic])
...
m4_define([mca_opal_btl_m4_config_component_list], [portals4, sm, tcp, usnic, openib, vader, scif, ugni, smcuda])
...
m4_define([mca_opal_hwloc_m4_config_component_list], [hwloc1112, external])
m4_define([mca_opal_hwloc_no_config_component_list], [])

dnl Components in the opal / if framework
m4_define([mca_opal_if_m4_config_component_list], [solaris_ipv6, posix_ipv4, bsdx_ipv6, linux_ipv6, bsdx_ipv4])
m4_define([mca_opal_if_no_config_component_list], [])

dnl Components in the opal / installdirs framework
m4_define([mca_opal_installdirs_m4_config_component_list], [env, config])
...
m4_define([mca_opal_memory_m4_config_component_list], [malloc_solaris, patcher, linux])
...
m4_define([mca_opal_mpool_no_config_component_list], [sm, grdma])
...
m4_define([mca_opal_pmix_m4_config_component_list], [s2, pmix112, external, s1, cray])
...
m4_define([mca_orte_dfs_no_config_component_list], [test, orted, app])

dnl Components in the orte / errmgr framework
m4_define([mca_orte_errmgr_m4_config_component_list], [])
m4_define([mca_orte_errmgr_no_config_component_list], [default_tool, default_app, default_orted, default_hnp])

dnl Components in the orte / ess framework
m4_define([mca_orte_ess_m4_config_component_list], [alps, tm, lsf, slurm])
m4_define([mca_orte_ess_no_config_component_list], [env, hnp, tool, singleton, pmi])
...
m4_define([mca_orte_iof_no_config_component_list], [hnp, tool, orted, mr_orted, mr_hnp])
...
m4_define([mca_orte_oob_m4_config_component_list], [tcp, alps, ud, usock])
m4_define([mca_orte_oob_no_config_component_list], [])

dnl Components in the orte / plm framework
m4_define([mca_orte_plm_m4_config_component_list], [rsh, alps, tm, isolated, lsf, slurm])
m4_define([mca_orte_plm_no_config_component_list], [])

dnl Components in the orte / ras framework
m4_define([mca_orte_ras_m4_config_component_list], [gridengine, alps, tm, lsf, loadleveler, slurm])
...
m4_define([mca_orte_rmaps_no_config_component_list], [ppr, round_robin, seq, rank_file, resilient, mindist, staged])
...
m4_define([mca_orte_routed_no_config_component_list], [binomial, radix, direct, debruijn])
...
m4_define([mca_orte_state_no_config_component_list], [hnp, novm, staged_hnp, tool, orted, app, staged_orted, dvm])
...
m4_define([mca_ompi_coll_m4_config_component_list], [portals4, fca, cuda, hcoll])
m4_define([mca_ompi_coll_no_config_component_list], [sync, sm, libnbc, inter, basic, tuned, self])

dnl Components in the ompi / fbtl framework
m4_define([mca_ompi_fbtl_m4_config_component_list], [plfs, pvfs2, posix])
...
m4_define([mca_ompi_fcoll_no_config_component_list], [dynamic, two_phase, individual, static])

dnl Components in the ompi / fs framework
m4_define([mca_ompi_fs_m4_config_component_list], [plfs, lustre, pvfs2])
...
m4_define([mca_ompi_mtl_m4_config_component_list], [portals4, ofi, mxm, psm2, psm])
...
m4_define([mca_ompi_pml_m4_config_component_list], [ucx, yalla, v, ob1])
...
m4_define([mca_oshmem_sshmem_m4_config_component_list], [verbs, mmap, sysv])
